...
if(preg_match('/iPhone|Android|Blackberry/i', $agent)){  
    header("Location: ellielitzenberg_mobile00.html");  
    exit;  
...
<title>EllieLitzenberg.html</title>
...
<div class="menu_container">
    <nav id="top">  
      <ul>
        <li class="home"><a class="toplink" href="http://www.ellielitzenberg.com">Home</a>  
          <!-- <ul>  
...
<!--                 <p>Github: <a href="https://github.com/KevinLitzenberg" target="blank">Github Profile</a> -->
                 <p>Contact: <a href="mailto:ellie.litzenberg@gmail.com" target="blank">ellie.litzenberg@gmail.com</a>
